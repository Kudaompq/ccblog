<template>
  <div>
    <CommentForm v-if="parentCommentId === -1" ></CommentForm>
    ...
    <div class="comment" v-for="comment in comments" :key="comment.id">
      ...
      <div class="content">
        <a :href="comment.website !== '' && comment.website !== null ? comment.website : null" target="_blank" rel="external nofollow noopener">{{comment.nickname}}</a>
