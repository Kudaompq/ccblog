  ...
  <div class="app-container">
    ...
    <el-row style="margin-top: 20px">
      <el-card>
        ...
        <el-form :inline="true" v-for="badge in typeMap.type2" :key="badge.id" size="mini">
...
import {getSiteSettingList,updateSiteSetting} from "@/api/siteSetting";
...
export default {
  ...
  methods:{
    ...
    submit(){
      ...
      updateSiteSetting(updateArr,this.deleteIds).then(res =>{
        if (res.code === 200){
          this.deleteIds = []
          this.getData()
